...
import { 
  ...
  Lightbulb, RefreshCw, PlayCircle
} from 'lucide-react';
import { 
...
export default function Zone2BrainMemoryMasterclass() {
  ...
  return (
    <article className="space-y-8 animate-fade-in font-sans text-stone-900">
      ...
      {/* FEATURED VIDEO SPOTLIGHT: DR. LEWIS CLARKE */}
      <div className="p-6 rounded-3xl bg-stone-900 text-white border border-stone-800 shadow-xl space-y-6">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-black uppercase tracking-wider text-red-400">Featured Video Spotlight</span>
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-stone-800 text-stone-300 font-mono">YouTube Short</span>
              </div>
              <h2 className="text-xl font-black text-white">How Exercise Creates New Brain Cells</h2>
            </div>
          </div>
          
          <a
            href="https://youtube.com/shorts/zLnHqTBA2UE?si=8lM_AgOvBiK6cK66"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold transition shadow-xs"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          {/* YouTube Video Embed Player (9:16 Shorts aspect ratio) */}
          <div className="md:col-span-5 flex justify-center">
            <div className="w-full max-w-[260px] sm:max-w-[280px] aspect-[9/16] rounded-2xl overflow-hidden border-2 border-stone-700 shadow-2xl bg-black relative">
              <iframe
                src="https://www.youtube.com/embed/zLnHqTBA2UE"
                title="How Exercise Creates New Brain Cells - Dr. Lewis Clarke"
          ...
          {/* Video Key Takeaways & Clinical Grounding */}
          <div className="md:col-span-7 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-500 text-white flex items-center justify-center font-bold text-xs shadow-xs shrink-0">
                LC
              </div>
              <div>
                <div className="text-sm font-bold text-white flex items-center gap-2">
                  <span>Dr. Lewis Clarke, MD, PhD</span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-purple-500/20 text-purple-300 border border-purple-500/30">
                    Fixing The Broken Brain
                  </span>
                </div>
                <div className="text-xs text-stone-400">Neuro-Rehabilitation & Metabolic Brain Health</div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-stone-800/80 border border-stone-700/60 space-y-3">
              <div className="text-xs font-bold uppercase tracking-wider text-purple-300 flex items-center gap-1.5">
                ...
                Key Neurogenesis Takeaways
              </div>
              <ul className="space-y-2.5 text-xs sm:text-sm text-stone-300 leading-relaxed">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-400 font-bold shrink-0">⚡ +200% Brain Cell Growth:</span>
                  <span>Aerobic running can boost adult brain cell creation by up to 200%, stimulating the rapid production of new hippocampal neurons.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-300 font-bold shrink-0">⏱️ The 30-Minute Aerobic Threshold:</span>
                  <span>Just 30 minutes of moderate aerobic exercise (Zone 2), 4–5 times a week, delivers the necessary stimulus to prevent cognitive decline.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400 font-bold shrink-0">🛡️ Active Memory Shield:</span>
                  <span>Steady aerobic conditioning keeps short-term memory sharp, protects executive function, and preserves synaptic plasticity as we age.</span>
                </li>
              </ul>
            </div>

            <div className="p-3.5 rounded-xl bg-purple-950/40 border border-purple-800/50 text-xs text-purple-200 flex items-center gap-2.5">
              <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
              <span>Directly matches Ishai's 45–75 min Zone 2 training protocol (101–120 BPM) for cellular and cerebral rejuvenation.</span>
            </div>
          </div>
        </div>
      </div>
