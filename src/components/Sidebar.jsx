...
export const PAGES_LIST = [
  { id: 1, title: 'What is Zone 2? (Easy Intro)', category: 'Fundamentals', icon: Smile, badge: 'Beginner' },
  { id: 2, title: 'FATmax Science & Bioenergetics', category: 'Fundamentals', icon: Flame, badge: 'Core' },
  { id: 3, title: 'Cell Engine & PGC-1α Biogenesis', category: 'Cell Biology', icon: Cpu, badge: 'Science' },
  { id: 4, title: 'Live Cell Visualizer', category: 'Cell Biology', icon: Zap, badge: '⭐ Featured' },
  { id: 5, title: 'Zone 2 vs. Other Sports', category: 'Cell Biology', icon: BarChart2, badge: 'Comparison' },
  { id: 6, title: 'Lactate Paradox & Shuttle', category: 'Cell Biology', icon: Activity, badge: 'Mythbusting' },
  { id: 7, title: '1-Hour Field Experiment', category: 'Field Studies', icon: Clock, badge: 'Data' },
  { id: 8, title: 'Longevity Masterclass & Protocols', category: 'Field Studies', icon: ShieldCheck, badge: 'Health' },
  { id: 9, title: 'Ishai Athlete Profile', category: 'Personal Data', icon: User, badge: '👤 Profile' },
  { id: 10, title: 'Watch Runs & Strava Data', category: 'Personal Data', icon: Heart, badge: '🏃‍♂️ Strava' },
  { id: 11, title: 'Zone 2 & Recovery Mastery', category: 'Protocols', icon: BatteryCharging, badge: '🔋 Fuel' },
  { id: 12, title: 'Aerobic Expectations & HR Drift', category: 'Protocols', icon: TrendingUp, badge: 'HR Drift' },
  { id: 13, title: 'Nutrition & Blood Pressure', category: 'Protocols', icon: Droplet, badge: '🥗 Health' },
  { id: 14, title: 'Heat & Humidity Guide', category: 'Protocols', icon: Sun, badge: '☀️ Weather' },
  { id: 15, title: 'Whole-Body Organ Systems', category: 'Deep Physiology', icon: Layers, badge: '🫀 Organs' },
  { id: 16, title: 'Run Progress & Analytics Table', category: 'Deep Physiology', icon: Award, badge: '📈 Analytics' },
  { id: 17, title: 'Bacterial & Mitochondrial Evolution', category: 'Deep Physiology', icon: Dna, badge: '🦠 Evolution' },
  { id: 18, title: "Runner's License & Certification", category: 'Fundamentals', icon: Award, badge: '📜 License' },
  { id: 19, title: 'How the Human Body Creates Fat', category: 'Deep Physiology', icon: Layers, badge: '🧪 Lipogenesis' },
];
