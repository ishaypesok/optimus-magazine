...
export default function LactateMasterclass() {
  ...
  const ZONE_LACTATE_SPECS = {
    ...
    2: { name: 'Zone 2 (Target: 110–124 BPM)', concentration: '1.5 - 2.0 mmol/L', status: 'Optimal Steady State (LT1)', clearanceRate: 100, productionRate: 65, hPlusAcidosis: 'Zero Buffering Stress', desc: 'Lactate clearance matches production 1:1! MCT-1 transporters shuttle lactate directly into mitochondria without H+ accumulation.' },
